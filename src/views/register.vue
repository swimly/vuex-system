<template>
  <div class="login h row w">
    <div class="col v-m t-c">
      <h1 class="logo mid-layout"><img src="static/img/logo.png" alt=""></h1>
      <div class="banner">
        <div class="mid-layout h t-l">
...
<script>
  ...
  export default {
    ...
    methods: {
      submit () {
        api.regByEmail(this.email, this.password, this)
      }
    }
  }
</script>
